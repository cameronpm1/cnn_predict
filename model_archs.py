...
class EncoderDecoder(torch.nn.Module):
    '''
    code written by Boyuan Chen
    https://github.com/BoyuanChen/neural-state-variables/blob/main/models.py
    '''
...
class RefineCube2DModel(torch.nn.Module):
    def __init__(self, in_channels):
        super(RefineCube2DModel, self).__init__()
